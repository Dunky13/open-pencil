...
export interface ExportStorybookOptions {
  ...
  pageId?: string
  /** Names the document in each story's first line; see `generatedStoryHeader`. */
  source?: string
...
/**
 * The first line of every story generated from `source`, so a re-export can find the
 * files it owns and leave hand-written stories and other documents' stories alone.
 */
function generatedStoryHeader(source: string): string {
  return `// Generated by OpenPencil from ${source}. Re-export to update; edits are overwritten.`
}

const GENERATED_HEADER =
  /^\/\/ Generated by OpenPencil from (.+)\. Re-export to update; edits are overwritten\.$/
